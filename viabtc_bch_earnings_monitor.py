...
COOKIE = os.getenv("VIABTC_BCH_COOKIE") or os.getenv("VIABTC_COOKIE")
CHAT_ID = os.getenv("BCH_TELEGRAM_CHAT_ID") or os.getenv("TELEGRAM_CHAT_ID")
TOKEN = os.getenv("BCH_TELEGRAM_TOKEN") or os.getenv("TELEGRAM_TOKEN")
TMP_FILE = Path(os.getenv("VIABTC_BCH_EARNINGS_STATE_FILE", BASE_DIR / "via_bch_last_payout_height.txt"))
BG_IMAGE = Path(os.getenv("VIABTC_BCH_EARNINGS_BG_IMAGE", BASE_DIR / "earnings_bg.png"))
TEMP_OUTPUT = Path(
    os.getenv(
        "VIABTC_BCH_EARNINGS_TEMP_OUTPUT",
        Path(tempfile.gettempdir()) / "temp_earnings_card_bch.png",
    )
)
API_URL_TEMPLATE = (
...
if __name__ == "__main__":
    try:
        CHAT_ID = require_env("BCH_TELEGRAM_CHAT_ID") if os.getenv("BCH_TELEGRAM_CHAT_ID") else require_env("TELEGRAM_CHAT_ID")
        TOKEN = require_env("BCH_TELEGRAM_TOKEN") if os.getenv("BCH_TELEGRAM_TOKEN") else require_env("TELEGRAM_TOKEN")
        ...
        for pay in new_payouts:
            ...
            logger.info("Sent BCH payout for block %s", p_h)
        ...
        logger.exception("viabtc_bch_earnings_monitor.py failed")
